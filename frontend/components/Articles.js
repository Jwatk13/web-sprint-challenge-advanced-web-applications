...
export default function Articles(props) {
  ...
  localStorage.getItem("token") === null ? <Navigate to="/"/> : <Navigate to="/articles" />
  ...
  return (
    ...
    // when I click edit, I want to populate the input form with the values of the article clicked on
